    ...
    return(
        <div class="container py-5">
            <div class="blog-header text-center py-3">
                <p class="main-heading">Latest Blog Posts</p>
                <p class="card-text sub-heading">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
            </div>
